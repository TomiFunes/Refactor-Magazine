...
export const dict = {
  es: {
    ...
    about_p1: "Soy desarrollador de software con años construyendo productos digitales — desde APIs de alto rendimiento hasta interfaces obsesivamente cuidadas. Escribo sobre lo que aprendo en el camino.",
    about_p2_pre: "",
  ...
  en: {
    ...
    about_p1: "I'm a software developer with years building digital products — from high-performance APIs to obsessively polished interfaces. I write about what I learn along the way.",
    about_p2_pre: "",
    about_p2_strong: "Refactor Magazine",
